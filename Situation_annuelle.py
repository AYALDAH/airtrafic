...
#sidebar configuration
    ...
    # Créer un graphique Plotly Express
        ...
        fig1.update_layout(width=300, height=500, bargap=0.1, plot_bgcolor='rgba(0,0,0,0)', paper_bgcolor='rgba(0,0,0,0)')
    ...
    tickangle=45,  # Angle de rotation des étiquettes (facultatif)
        ...
        fig2.update_layout(width=300, height=500, bargap=0.1,
