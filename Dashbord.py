...
#---------------------------------------------------------------------------------------
    ...
    if  Analyse_Exploratoire == 'Analyse_univariée':
        ...
        fig1.update_layout(title = dict(text = "Attrition et Effectif par secteur "), width=340, height=380,annotations=[dict(text='attrition', x=0.50, y=0.5, font_size=20, showarrow=False)])
...
# Update layout and appearance of the plot
        ...
        fig12.update_layout(width=410, height=400, bargap=0.1,
                  plot_bgcolor='rgba(0,0,0,0)', paper_bgcolor='rgba(0,0,0,0)')
