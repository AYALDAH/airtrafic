  ...
  #---------------------------------------------------------------------------------------
    ...
    #Voir les détails par site
        ...
        #Secteur d'activité
            ...
            colors = ["#ff7f0e", "#1f77b4", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf","#ff9896","#c5b0d5"]
            treemap1= px.treemap(filtered_data_top,path=["SECTEUR_ACTIVITE_PRINCIPAL"],title="",color_continuous_scale="cividis")
