...
#---------------------------------------------------------------------------------------
    ...
    if  Analyse_Exploratoire == 'Analyse_univariée':
        ...
        fig1.update_layout(title = dict(text = "Attrition et activité principale"), width=300, height=400,annotations=[dict(text='attrition', x=0.50, y=0.5, font_size=20, showarrow=False)])
...
# Affichage du titre dans la deuxième colonne
    ...
    # Afficher l'image dans Streamlit
        ...
        if st.sidebar.button("Silhouette_visualizer"):
            image_silo = Image.open('Silou_str.png')
            st.image(image_silo)
