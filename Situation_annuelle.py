...
#---------------------------------------------------------------------------------------
          ...
          #Répartition des sites par nombre de TEU
                  ...
                  fig1.update_layout(title='Bar Plot', plot_bgcolor='rgba(0,0,0,0)', paper_bgcolor='rgba(0,1,1,0)', width=400, height=400, xaxis=dict(title="TEU"),  # Add x-axis label
           ...
           #Répartition des sites par CA
                  ...
                  fig2.update_layout(title='Bar Plot', plot_bgcolor='rgba(0,0,0,0)', paper_bgcolor='rgba(0,1,1,0)', width=400, height=400, xaxis=dict(title="CA"),  # Add x-axis label
                  yaxis=dict(title="Site"),)
...
page = st.sidebar.radio("Visualisation", ["Resumé","Analyse Exploratoire", "Machine Learning"])
